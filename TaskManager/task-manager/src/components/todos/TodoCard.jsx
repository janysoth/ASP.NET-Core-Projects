    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-start justify-between gap-2">
          ...
          {dueDate && (
            <span
              className={`flex flex-shrink-0 items-center gap-1 rounded-full px-2 py-1 text-xs ${dueDate.isOverdue
      ...
      <div className="flex items-center gap-1 opacity-0 transition-opacity duration-200 group-hover:opacity-100">
        ...
        <button
          ...
          className="rounded-lg p-2 text-[var(--app-text-muted)] transition-colors duration-200 hover:bg-red-50 hover:text-red-600"
          title="Delete"
        >
